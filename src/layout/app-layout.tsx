...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'travel-planner', 'it-administrator', 'customer-service-representative'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Quotes', path: '/quotes', entity: 'quote', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },

...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'destination.update': {
    roles: ['business-owner', 'travel-planner', 'it-administrator', 'customer-service-representative'],
  ...
  'itinerary.update': {
    roles: ['business-owner', 'travel-planner', 'it-administrator', 'customer-service-representative'],
    key: 'itinerary-changed',
    tenantPath: ['organization', 'user', 'itinerary'],
    userPath: [],
  },
  'quote.create': {
    roles: ['business-owner', 'travel-planner', 'it-administrator', 'customer-service-representative'],
    key: 'quote-generated',
    tenantPath: ['organization', 'user', 'itinerary', 'quote'],
    userPath: [],
  },
};
